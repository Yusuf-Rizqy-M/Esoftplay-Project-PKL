...
.bg-image-container img{
    ...
    transform:scale(1.1); /* Kecilin sedikit dengan zoom out halus */
    opacity:0;
...
.styled-quote-mark{font-size:50px;color:#4DA3FF;line-height:1;margin-bottom:15px;font-family:serif}
...
dots.forEach((dot, i) => {
    dot.addEventListener('click', () => {
        ...
        startInterval(); // Restart interval setelah klik
    });
});
</script>
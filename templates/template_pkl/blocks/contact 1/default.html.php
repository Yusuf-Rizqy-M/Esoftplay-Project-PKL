...
<style>
    ...
    /* KONTINER UTAMA: Border Biru & Putih (Sesuai Figma) */
    ...
    /* PESAWAT KERTAS (Persis di bawah tombol menjuntai ke luar) */
    .plane-deco {
        position: absolute;
        bottom: -30px; /* Menjuntai keluar kotak sesuai Figma */
        right: 120px;
        width: 180px;
        pointer-events: none;
        z-index: 10;
...
<section class="contact-wrapper">
    ...
    <div class="contact-card-container">
        <div class="contact-info-panel">
            ...
            <p class="sub-text">This is our contact! Call us</p>
            ...
            <div class="info-detail">
                ...
                <p>Prambatan Kidul, Kecamatan Kaliwungu, Kabupaten Kudus.</p>
            </div>
            ...
            <form action="" method="POST">
                <div class="contact-grid">
                    ...
                    <div class="field-group full-row">
                        <label>Pesan</label>
                        <textarea name="pesan" rows="1" placeholder="Tuliskan Pesanmu.."></textarea>
                    </div>
                </div>
